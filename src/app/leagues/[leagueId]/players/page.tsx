    ...
    <div className="min-h-screen bg-zinc-50 px-6 py-16">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 rounded-3xl bg-white p-10 shadow-sm">
        ...
        <section className="rounded-2xl border border-zinc-100 bg-zinc-50/80 p-6">
          <div className="flex flex-col gap-2">
            <h2 className="text-xl font-semibold text-black">League rules</h2>
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-sm font-medium text-zinc-700">Bench rules</p>
              <ul className="list-disc space-y-1 pl-5 text-sm text-zinc-600">
                <li>
                ...
                <li>
                  ...
                  eligible bench player is substituted in automatically.
                </li>
              </ul>
            </div>
